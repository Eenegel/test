...
public class MailHomePage {
    ...
    private Element loginInput = new Element(By.id("mailbox:login"));
    private Element passwordInput = new Element(By.id("mailbox:password"));
    private Element submitButton = new Element(By.xpath("//input[@type='submit']"));
    private Element authFail = new Element(By.id("mailbox:error"));
